...
function Gems35xxFeeder(parent, id) {
  ...
  self.items = {
    type: {
      ...
      values: [],
      registered: false,
      address: 32420 + (id - 1) * 64 + 0,
      type: 'readUInt16BE',
      converter: FeederType
    },
    leakageCurrent: {
      value: undefined,
      values: [],
      registered: false,
      address: 32420 + (id - 1) * 64 + 1,
      type: 'readUInt16BE',
    ...
    demandMaxPower: {
      ...
      values: [],
      registered: false,
      address: 36000 + (id - 1) * 34 + 30,
      type: 'readInt32BE',
      converter: undefined
    },
    demandPredictionPower: {
      value: undefined,
      values: [],
      registered: false,
      address: 36000 + (id - 1) * 34 + 32,
      type: 'readUInt32BE',
      converter: undefined
    },
    ...
    reactiveEnergy: {
      ...
      values: [],
      registered: false,
      address: 38000 + (id - 1) * 18 + 6,
      type: 'readUInt32BE',
      converter: EnergyConverter
    },
    thisMonthReactiveEnergy: {
      value: undefined,
      values: [],
      registered: false,
      address: 38000 + (id - 1) * 18 + 8,
      type: 'readUInt32BE',
      converter: EnergyConverter
    },
    lastMonthReactiveEnergy: {
      value: undefined,
      values: [],
      registered: false,
      address: 38000 + (id - 1) * 18 + 10,
      type: 'readUInt32BE',
      converter: EnergyConverter
    },
    apparentEnergy: {
      ...
      values: [],
      registered: false,
      address: 38000 + (id - 1) * 18 + 12,
      type: 'readUInt32BE',
      converter: EnergyConverter
    },
    thisMonthApparentEnergy: {
      value: undefined,
      values: [],
      registered: false,
      address: 38000 + (id - 1) * 18 + 14,
      type: 'readUInt32BE',
      converter: EnergyConverter
    },
    lastMonthApparentEnergy: {
      value: undefined,
      values: [],
      registered: false,
      address: 38000 + (id - 1) * 18 + 16,
      type: 'readUInt32BE',
      converter: EnergyConverter
    }
  };
